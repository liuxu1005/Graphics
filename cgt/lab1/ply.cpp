...
void ply::scaleAndCenter() {
  ...
  for (i = 0; i < vertexCount; i++){
    ...
    if (maxX < vertexList[i].x) maxX = vertexList[i].x;
    if (minX > vertexList[i].x) minX = vertexList[i].x;
    if (maxY < vertexList[i].y) maxY = vertexList[i].y;
    if (minY > vertexList[i].y) minY = vertexList[i].y;
    if (maxZ < vertexList[i].z) maxZ = vertexList[i].z;
    if (minZ > vertexList[i].z) minZ = vertexList[i].z;
  ...
  for (i = 0; i < vertexCount; i++){
    vertexList[i].x = ratio * (vertexList[i].x - (minX + maxX)/2);
    vertexList[i].y = ratio * (vertexList[i].y - (minY + maxY)/2);
    vertexList[i].z = ratio * (vertexList[i].z - (minZ + maxZ)/2);
  }
...
void ply::render(){
	...
	//glBegin(GL_POINTS);
	// sets the shapes that openGL draws and determines
	...
	*/
	for (int i = 0; i < faceCount; i++) {
	    setNormal(vertexList[faceList[i].vertexList[0]].x,
	              vertexList[faceList[i].vertexList[0]].y,
	              vertexList[faceList[i].vertexList[0]].z,  
	              vertexList[faceList[i].vertexList[1]].x,
	              vertexList[faceList[i].vertexList[1]].y,
	              vertexList[faceList[i].vertexList[1]].z, 
	              vertexList[faceList[i].vertexList[2]].x,
	              vertexList[faceList[i].vertexList[2]].y,
	              vertexList[faceList[i].vertexList[2]].z);
	              
	    glVertex3f(vertexList[faceList[i].vertexList[0]].x,
	              vertexList[faceList[i].vertexList[0]].y,
	              vertexList[faceList[i].vertexList[0]].z);   
	    glVertex3f(vertexList[faceList[i].vertexList[1]].x,
	              vertexList[faceList[i].vertexList[1]].y,
	              vertexList[faceList[i].vertexList[1]].z);   
	    glVertex3f(vertexList[faceList[i].vertexList[2]].x,
	              vertexList[faceList[i].vertexList[2]].y,
	              vertexList[faceList[i].vertexList[2]].z);
